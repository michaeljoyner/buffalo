    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['url' => '/admin/customers', 'class' => 'form-horizontal dd-form modal-form', 'id' => 'new-customer-form']) !!}
                @include('errors')
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="new-customer-form" class="btn dd-btn dd-modal-confirm-btn">Create</button>
            </div>
            {!! Form::close() !!}
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
